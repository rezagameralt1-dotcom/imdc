...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::connection('core')->hasTable('pub.pharma_events')) {
            return;
        }

        Schema::connection('core')->create('pub.pharma_events', function (Blueprint $table) {
    ...
    {
        Schema::connection('core')->dropIfExists('pub.pharma_events');
    }
};
